...
public class CommonXpathFactory {
    ...
    public static String getInputXpath(String inputLabel) {
        return "//label[contains(text(),'" + inputLabel + "')]/ancestor::lightning-input/div/input//span[contains(text(),'" + inputLabel + "')]/parent::label/following-sibling::input";
        //
    }
    ...
    public static String getComboboxByLabel(String comboboxLabel) {
    ...
    public static String getComboboxItem(String itemName) {
    ...
    public static String getTeaxtareaXpath(String textAreaLabel) {
    ...
    public static String getButtonXpath(String buttonText) {
        return "//button[text()='" + buttonText + "']||//div[contains(@style,'opacity: 1')]//span[text()='" + buttonText + "']/parent::button";
    }

    public static String foxLoading() {
